...
此脚本用于从书源JSON文件中提取网站信息，并自动生成支持网站列表的Markdown文档。
主要功能：
1. 遍历BookSource目录下的书源文件
2. 提取每个书源的名称和网址
3. 按分类（日轻、国轻、日语原版）生成Markdown表格
4. 自动更新 docs/websites.md 文件

此脚本通常在发布新版本后自动运行，确保文档与实际书源保持同步。
"""
